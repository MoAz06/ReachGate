...
Packaging note:
  Canonical home of the SARIF export; ``tools/export_sarif.py`` is a thin shim
  re-exporting from here. Default source/output paths resolve via
  :mod:`reachgate._resources`.
